...
"""Inference-only Qwen2 model compatible with HuggingFace weights. This is the MLX-backend version."""
...
class Qwen2Model(nn.Module):
    ...
    def get_input_embedding(self, input_ids: mx.array) -> mx.array:
    ...
    def load_kv_cache_scales(self, quantization_param_path: str) -> None:
        ...
        for layer_idx, scaling_factor in kv_cache_scales_loader(
            ...
            if not isinstance(self.layers[layer_idx], nn.Module):
